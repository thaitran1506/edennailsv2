  ...
  return (
    <div className="px-4 sm:px-8 md:px-16 lg:px-24 xl:px-40 flex flex-1 justify-center py-2">
      ...
      <div className="layout-content-container flex flex-col max-w-[960px] flex-1">
        <div className={`relative h-[300px] sm:h-[350px] md:h-[400px] rounded-2xl overflow-hidden mb-8 transition-all duration-1000 transform ${
          ...
          <div className="absolute inset-0 bg-gradient-to-br from-black/50 via-black/30 to-black/50 flex items-center justify-center">
            <div className="text-center text-white px-4">
              ...
              <p className={`text-lg sm:text-xl md:text-2xl mb-6 md:mb-8 transition-all duration-700 delay-500 ${
                isHeroVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
              }`}>
              ...
              <button
                ...
                className={`bg-[#eb477e] text-white px-6 sm:px-8 py-2 sm:py-3 rounded-lg text-base sm:text-lg font-semibold hover:bg-[#d63d6e] transition-all duration-300 transform hover:scale-105 hover:shadow-2xl relative overflow-hidden group ${
                  isHeroVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
                }`}
                style={{ transitionDelay: '700ms' }}
              >
                <span className="relative z-10">Book Your Appointment</span>
                <div className={`absolute inset-0 bg-gradient-to-r from-[#d63d6e] to-[#eb477e] transform transition-transform duration-300 ${
                  isButtonHovered ? 'translate-x-0' : '-translate-x-full'
                }`}></div>
                <div className="absolute inset-0 bg-white/20 transform transition-transform duration-300 group-hover:scale-150 group-hover:rotate-12"></div>
              </button>
            </div>
          </div>
        ...
        <div id="gallery" className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <div className="text-center mb-8">
            <h2 className="text-[#181113] text-xl sm:text-2xl md:text-[28px] font-bold leading-tight tracking-[-0.015em] px-4 pb-3 pt-5 hover:text-[#eb477e] transition-colors duration-300 cursor-default">
              Featured Nail Designs
            </h2>
            <p className="text-[#181113] text-sm sm:text-base font-normal leading-normal px-4 max-w-2xl mx-auto hover:text-[#88636f] transition-colors duration-300">
              Discover our latest nail art creations. Each design is crafted with precision and creativity to bring your vision to life.
            </p>
          </div>
              ...
              >
                ...
                <div className="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-30 transition-all duration-300 flex items-center justify-center">
                  <div className="opacity-0 group-hover:opacity-100 transition-all duration-300 transform scale-75 group-hover:scale-100">
                    <svg className="w-8 h-8 sm:w-12 sm:h-12 text-white animate-pulse" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                {/* Image Counter */}
                <div className="absolute top-2 sm:top-3 right-2 sm:right-3 bg-black bg-opacity-50 text-white text-xs px-2 py-1 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300 backdrop-blur-sm">
                  {index + 1} / {featuredImages.length}
                </div>

                {/* Enhanced Glow Effect */}
                <div className="absolute inset-0 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-gradient-to-r from-[#eb477e] to-[#d63d6e] blur-xl scale-110 -z-10 animate-pulse"></div>

                {/* Corner accent */}
                <div className="absolute top-0 left-0 w-8 h-8 border-l-2 border-t-2 border-white/30 opacity-0 group-hover:opacity-100 transition-all duration-300"></div>
                <div className="absolute bottom-0 right-0 w-8 h-8 border-r-2 border-b-2 border-white/30 opacity-0 group-hover:opacity-100 transition-all duration-300"></div>
              </div>
            ))}
          </div>
        </div>
      ...
      {selectedImage !== null && (
        ...
        >
          <div className="relative max-w-5xl max-h-full w-full h-full flex items-center justify-center">
            ...
            {/* Image Counter */}
            <div className="absolute bottom-2 sm:bottom-4 left-1/2 transform -translate-x-1/2 text-white text-center bg-black bg-opacity-50 px-3 sm:px-4 py-1 sm:py-2 rounded-full backdrop-blur-sm hover:bg-opacity-70 transition-all duration-200">
